...
*	사용자 정의 클래스의 계층 구조 분석

*	List Type의 Field 저장

*	문자열을 primitive type으로 변환

*	Interface에 정의된 method의 반환 값을 저장

5.	한계점

*	한정적인 Interface 분석

*	Entity 클래스를 상속해야만 id 식별 가능

*	검색 key를 정의할 때 반드시 명명 규칙을 따라야 작동

*	테스트 케이스가 현 프로젝트에만 한정
